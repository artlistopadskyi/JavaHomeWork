...
public class Library {
    public static void main(String[] args) {
        ...
        Reader[] readers = {
                new Reader("Петров В. В.", 10109940, "история", "10/10/1990", "+380807006050"),
                new Reader("Серов В. А.", 20109942, "рисования", "10/10/1991", "+380807006051"),
                new Reader("Брюллов К. П.", 30109943, "юриспруденция", "10/10/1992", "+380807006052")
        };
